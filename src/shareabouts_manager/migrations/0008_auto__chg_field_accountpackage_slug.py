...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AccountPackage.slug'
        db.alter_column(u'shareabouts_manager_accountpackage', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'AccountPackage.slug'
        db.alter_column(u'shareabouts_manager_accountpackage', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))

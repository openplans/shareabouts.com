...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountPackage.slug'
        db.add_column(u'shareabouts_manager_accountpackage', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountPackage.slug'
        db.delete_column(u'shareabouts_manager_accountpackage', 'slug')

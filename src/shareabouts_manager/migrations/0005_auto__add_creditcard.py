...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shareabouts_manager_creditcard', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'credit_cards', to=orm['shareabouts_manager.UserProfile'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('four', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('exp', self.gf('django.db.models.fields.DateField')(max_length=5)),
        ))
        db.send_create_signal(u'shareabouts_manager', ['CreditCard'])


    def backwards(self, orm):
        # Deleting model 'CreditCard'
        db.delete_table(u'shareabouts_manager_creditcard')

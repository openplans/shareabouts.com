...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountPackage.price'
        db.add_column(u'shareabouts_manager_accountpackage', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountPackage.price'
        db.delete_column(u'shareabouts_manager_accountpackage', 'price')

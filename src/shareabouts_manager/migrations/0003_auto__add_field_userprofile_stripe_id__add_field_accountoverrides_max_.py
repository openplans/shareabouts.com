...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shareabouts_manager_userprofile', 'stripe_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'AccountOverrides.max_places'
        db.add_column(u'shareabouts_manager_accountoverrides', 'max_places',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccountPackage.max_places'
        db.add_column(u'shareabouts_manager_accountpackage', 'max_places',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccountPackage.stripe_id'
        db.add_column(u'shareabouts_manager_accountpackage', 'stripe_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'shareabouts_manager_userprofile', 'stripe_id')

        # Deleting field 'AccountOverrides.max_places'
        db.delete_column(u'shareabouts_manager_accountoverrides', 'max_places')

        # Deleting field 'AccountPackage.max_places'
        db.delete_column(u'shareabouts_manager_accountpackage', 'max_places')

        # Deleting field 'AccountPackage.stripe_id'
        db.delete_column(u'shareabouts_manager_accountpackage', 'stripe_id')

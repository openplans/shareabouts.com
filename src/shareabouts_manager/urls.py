...
from shareabouts_manager.views import datasets_view, signup_view, signin_view, password_reset_view, help_view, robots_view, sitemap_view, index_view, profile_view, set_card_info_view, task_status_view
...
urlpatterns = patterns('',
    ...
    url(r'^check-task-status/(?P<task_id>.+)$', task_status_view, name='manager-task-status'),
